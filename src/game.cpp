...
void Game::interpret(const struct_cell& Cell) {//интерпритация клеток
...
void Game::createCell() {
    ...
    rect.setPosition(sf::Vector2f( ((mousePOS.x) / 8) * 8, ((mousePOS.y) / 8) * 8)); // Устанавливаем позицию клетки
